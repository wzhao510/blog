...
<template>
  <el-card class="page-container" style = "border-radius: 15px; background-color:#e1e1db">
    ...
    <el-table :data="categories" style="width: 100% ;" :header-cell-style="{background:'#e1e1db',color:'black'}"
    ...
    <el-dialog v-model="dialogVisible" :title="title" width="30%">
      <el-form ref="form" :model="categoryModel" :rules="rules" label-width="100px" style="padding-right: 30px;background-color:#e1e1db">
